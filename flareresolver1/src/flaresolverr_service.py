        ...
        while True:
            try:
                ...
                if not captcha or captcha == "":
                    ...
                    WebDriverWait(driver, SHORT_TIMEOUT).until_not(lambda driver: not captcha or captcha == "")
                ...
                if username_val and password_val:
                    ...
                    while _time.time() < deadline:
                        for req_sw in driver.requests:
                            if 'identity.getpostman.com/login' in req_sw.url and req_sw.method == 'POST' and req_sw.response:
                    ...
                    logging.info(f"[LOGIN] form body: {login_response_body}")
